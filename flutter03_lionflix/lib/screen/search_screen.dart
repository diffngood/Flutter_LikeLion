...
class SearchScreen extends StatefulWidget implements PreferredSizeWidget {
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            // 검색 결과가 나올 ListView
            // Column 이나 Row 등 사이즈를 정하지 못하는
            // 컨테이너에 리스트 뷰를 배치할 때는 Expanded 컨테이너를 사용해야 한다.
            // 컨테이너의 크기를 나중에(항목이 구성된 후)에 다시 조정되는 컨테이너이다.
