        ...
        InkWell(
          onTap: (){
            Navigator.of(context).push(
              ...
              // [ 크로미움 기반 Web Browser, Android : pop animation / iOS, ipadOS : slide animation]
              /*
              MaterialPageRoute(
              ...
              */
              // 플로터에서 제공해는 애니메이션 클래스 사용 (https://docs.flutter.dev/ui/widgets/animation)
              // 새롭게 나타나는 화면의 최초 위치 (x, y)
              PageRouteBuilder(
                // 보여줄 화면 객체를 지정한다.
